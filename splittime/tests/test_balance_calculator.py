...
class BalanceCalculator2MembersTests(TestCase):
    ...
    def test_balance_2_members_delete_expenses(self):
        ...
        balances = BalanceCalculator.calculateBalances(self.group2)
        self.assertEqual(len(balances), 2)
        self.assertEqual(balances[self.user1][self.user2]["USD"], 150.0)
        self.assertEqual(balances[self.user2][self.user1]["USD"], -150.0)
...
class BalanceCalculator3MembersTests(TestCase):
    ...
    def test_balances_3_members_3_expenses_delete_expenses(self):
        ...
        balances = BalanceCalculator.calculateBalances(self.group1)
        self.assertEqual(len(balances), 3)
        self.assertEqual(balances[self.user1][self.user2]["USD"], 500.0)
        self.assertEqual(balances[self.user2][self.user1]["USD"], -500.0)
        self.assertEqual(balances[self.user1][self.user3]["USD"], 500.0)
        self.assertEqual(balances[self.user3][self.user1]["USD"], -500.0)
        GroupHelpers.delete_expense(expense2, self.user1)
        balances = BalanceCalculator.calculateBalances(self.group1)
        self.assertEqual(len(balances), 3)
        self.assertEqual(balances[self.user1][self.user2]["USD"], 300.0)
